...
<a class="cardlink" href="/patterns/saga/"><span class="card"><span class="ct">↶ Saga / compensation</span><span class="cd">Declare undos in the topology; on failure the engine runs them newest-first as durable tasks, each fed its own step's input/result snapshots.</span></span></a>
